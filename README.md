...
- Reachability-aware path handling (`dns_resolved`, `reachable`, `probe_error`) to avoid overstating risk when hosts cannot be validated
- Evidence artifacts (before/after snapshots + probe request/response)
- Markdown reporting (`executive_summary.md`, `technical_annex.md`) with Data Quality counts
